...
export const CARD_DATA: Record<CardCategory, string[]> = {
  ...
  egyptian_celebs: [
    ...
    'يسرا', 'عادل إمام', 'محمود ياسين', 'فاتن حمامة', 'رشدي أباظة', 'سعاد حسني',
    'هاني شاكر', 'علاء مبارك', 'بشير الديك', 'مصطفى فهمي', 'نبيلة عبيد', 'سمير غانم',
    'فريد شوقي', 'شريف عرفة', 'مني زكي', 'أحمد السقا', 'هند صبري', 'كريم عبد العزيز',
  ],
  football_stars: [
    'رونالدو', 'ميسي', 'نيمار', 'مبابي', 'هالاند', 'بنزيمة',
    'لوكاكو', 'ساكا', 'فينيسيوس', 'ديبالا', 'كيليان', 'سالاح',
    'فيرمينو', 'ماني', 'موراتا', 'غريزمان', 'كانسيلو', 'برونو',
    'ثياغو', 'لوكاس', 'لامين', 'بيدري', 'غافي', 'بيلينغهام',
  ],
  food: [
    'كشري', 'فول', 'طعمية', 'كباب', 'مشوي', 'كنافة',
    'بقلاوة', 'أم علي', 'ملوخية', 'مكرونة', 'بيتزا', 'برجر',
    'سوشي', 'شاورما', 'فلافل', 'حمص', 'تبولة', 'منسف',
    'كفتة', 'سمك', 'جمبري', 'بطاطس', 'سلطة', 'آيس كريم',
  ],
};
