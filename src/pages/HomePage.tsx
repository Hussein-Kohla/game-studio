...
import { Box, FileQuestion, Settings, X } from 'lucide-react';
...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-8 z-10 w-full max-w-6xl justify-center">
        
        {/* Game 1 Card */}
        <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.05} transitionSpeed={2500} className="w-full md:w-1/2 max-w-md">
          ...
          >
            ...
            {!isAuthenticated ? (
              <form onSubmit={handleAdminLogin} className="flex flex-col gap-4">
                ...
                <Button type="submit" variant="purple" className="w-full mt-2">
                  دخول
                </Button>
              </form>
            ) : (
